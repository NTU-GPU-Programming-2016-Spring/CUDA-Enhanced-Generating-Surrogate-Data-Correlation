...
nvcc -c --std=c++11 -arch=sm_30 -lcufft -lcurand -I ./src/headers/ ./src/time_series_aaft.cu -o ./debug/time_series_aaft.o
nvcc -c --std=c++11 -arch=sm_30 ./src/fmri_corr_coef.cu -o ./debug/fmri_corr_coef.o
nvcc --std=c++11 -arch=sm_30 -lcufft -lcurand ./debug/time_series_aaft.o ./debug/fmri_corr_coef.o ./src/main.cu -o ./debug/out
